...
import com.phasetranscrystal.fpsmatch.common.client.minimap.render.NeoForgeGuiGraphicsMinimapDrawTarget;
...
public final class Ldlib2MinimapCanvasElement extends UIElement {
    ...
    public Ldlib2MinimapCanvasElement(
        ...
        style(style -> style.clip(Clip.MASK).mask(clip));
    }
    ...
    protected void drawBackgroundAdditional(IGUIContext context) {
        ...
        new GuiGraphicsMinimapDrawBackend(
                new NeoForgeGuiGraphicsMinimapDrawTarget(
                        guiContext.graphics, textures
                ),
                getPositionX(),
                getPositionY(),
                getSizeWidth(),
