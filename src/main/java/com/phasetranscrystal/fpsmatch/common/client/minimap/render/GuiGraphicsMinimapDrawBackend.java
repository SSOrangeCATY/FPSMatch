...
import com.phasetranscrystal.fpsmatch.core.minimap.view.ProjectedPose;
...
public final class GuiGraphicsMinimapDrawBackend implements MinimapDrawBackend {
    ...
    public interface DrawTarget {
        ...
        void marker(
                String markerId,
                com.phasetranscrystal.fpsmatch.core.minimap.model.NamespacedId typeId,
                com.phasetranscrystal.fpsmatch.core.minimap.model.NamespacedId styleId,
                double x,
                double y,
                float yawDegrees,
                float opacity,
        ...
        default void label(
                com.phasetranscrystal.fpsmatch.core.minimap.model.DisplayLabel label,
                double x,
                double y,
                int color,
                double scale,
