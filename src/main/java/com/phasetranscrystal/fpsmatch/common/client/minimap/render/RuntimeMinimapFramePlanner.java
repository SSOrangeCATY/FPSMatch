...
import com.phasetranscrystal.fpsmatch.common.client.minimap.tactical.TacticalViewport;
...
import com.phasetranscrystal.fpsmatch.core.minimap.model.AutoFloorSelector;
import com.phasetranscrystal.fpsmatch.core.minimap.model.AutoFloorState;
...
import com.phasetranscrystal.fpsmatch.core.minimap.model.Vector2D;
...
import com.phasetranscrystal.fpsmatch.core.minimap.view.LabelCandidate;
import com.phasetranscrystal.fpsmatch.core.minimap.view.LabelCollisionResolver;
...
public final class RuntimeMinimapFramePlanner {
    ...
    private MinimapFrame planTactical(
        ...
        RuntimeFloor selectedFloor = floorState.effectiveFloorId()
                ...
                .orElse(fallback);
        if (floorState.mode()
                == com.phasetranscrystal.fpsmatch.core.minimap.view.FloorViewMode.MANUAL
    ...
    private static List<MapDrawCommand> regionCommands(
        ...
        Map<com.phasetranscrystal.fpsmatch.core.minimap.model.NamespacedId,
