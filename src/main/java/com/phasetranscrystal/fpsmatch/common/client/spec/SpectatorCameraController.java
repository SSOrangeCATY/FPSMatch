...
public final class SpectatorCameraController {
    ...
    public static void applyToCamera(Camera camera, float partialTick) {
        ...
        ((com.phasetranscrystal.fpsmatch.mixin.spec.teammate.CameraInvokerMixin) camera).invokeSetPosition(position.x, position.y, position.z);
        ((com.phasetranscrystal.fpsmatch.mixin.spec.teammate.CameraInvokerMixin) camera).invokeSetRotation(yaw, pitch);
    }
