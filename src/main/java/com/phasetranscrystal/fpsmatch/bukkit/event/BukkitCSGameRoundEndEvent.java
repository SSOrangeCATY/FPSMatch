...
public class BukkitCSGameRoundEndEvent extends Event {
    ...
    private final com.phasetranscrystal.fpsmatch.common.cs.map.CSGameMap.WinnerReason reason;
    private int winnerMoney;

    public BukkitCSGameRoundEndEvent(BaseMap map, BaseTeam winner, com.phasetranscrystal.fpsmatch.common.cs.map.CSGameMap.WinnerReason reason, int winnerMoney) {
        this.map = map;
        this.winner = winner;
        this.reason = reason;
    ...
    public com.phasetranscrystal.fpsmatch.common.cs.map.CSGameMap.WinnerReason getReason() { return reason; }
