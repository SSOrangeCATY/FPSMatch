...
public final class MinimapHardLimits {
    ...
    public static final long MAX_RUNTIME_CONTAINER_UPLOAD_BYTES =
            MAX_RUNTIME_EXPANDED_BYTES
                    ...
                    * (30L + 46L + 2L * MAX_ENTRY_PATH_UTF8_BYTES)
                    + 22L;
    public static final long MAX_BUILTIN_RUNTIME_CATALOG_BYTES = MAX_WIRE_TRANSFER_BYTES;
    ...
    public static final long MAX_SNAPSHOT_MANIFEST_DECLARED_BYTES = 512L * 1024 * 1024;
