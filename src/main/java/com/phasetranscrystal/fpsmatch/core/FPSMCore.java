...
public class FPSMCore {
    ...
    private static final Map<String, ShopItemData> GAMES_DEFAULT_SHOP_DATA = new HashMap<>();
    private static final Map<String, Map<UUID, ShopItemData>> GAMES_SHOP_DATA = new HashMap<>();
    ...
    public static void registerGameType(String typeName, BiFunction<ServerLevel,List<String>,BaseMap> map,boolean enableShop){
        ...
        if(enableShop) GAMES_DEFAULT_SHOP_DATA.put(typeName,new ShopItemData());
    }
    ...
    public static void setGameDefaultData(String gameType,ShopItemData data){
    ...
    public static void addPlayerShopData(String gameType,UUID player, ShopItemData data){
        if (checkGameIsEnableShop(gameType)){
            Map<UUID, ShopItemData> shopData = GAMES_SHOP_DATA.get(gameType);
