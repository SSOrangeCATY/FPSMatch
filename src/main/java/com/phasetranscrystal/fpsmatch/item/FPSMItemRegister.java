...
public class FPSMItemRegister {
    ...
    public static final RegistryObject<BaseThrowAbleItem> SMOKE_SHELL = ITEMS.register("smoke_shell", () -> new BaseThrowAbleItem(new Item.Properties(), SmokeShellEntity::new));
    ...
    public static final RegistryObject<BaseThrowAbleItem> GRENADE = ITEMS.register("grenade", () -> new BaseThrowAbleItem(new Item.Properties(), GrenadeEntity::new));
    public static final RegistryObject<BaseThrowAbleItem> FLASH_BOMB = ITEMS.register("flash_bomb", () -> new BaseThrowAbleItem(new Item.Properties(), FlashBombEntity::new));
}
