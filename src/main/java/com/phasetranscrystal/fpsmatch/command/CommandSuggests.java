...
public class CommandSuggests {
    ...
    public static final FPSMSuggestionProvider MAP_NAMES_WITH_AME_TYPE_SUGGESTION = new FPSMSuggestionProvider((c, b)-> CommandSuggests.getSuggestions(b, FPSMCore.getMapNames(StringArgumentType.getString(c, "gameType"))));
