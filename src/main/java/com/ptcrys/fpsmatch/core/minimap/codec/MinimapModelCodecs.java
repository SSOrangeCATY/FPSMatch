package com.ptcrys.fpsmatch.core.minimap.codec;
...
import com.ptcrys.fpsmatch.core.minimap.model.ConnectionDisplayDirection;
...
import com.ptcrys.fpsmatch.core.minimap.model.ConnectionType;
...
import com.ptcrys.fpsmatch.core.minimap.model.GeometryType;
import com.ptcrys.fpsmatch.core.minimap.model.IconAppearance;
...
import com.ptcrys.fpsmatch.core.minimap.model.MinimapStyle;
...
import com.ptcrys.fpsmatch.core.minimap.model.VectorObject;
import com.ptcrys.fpsmatch.core.minimap.model.VectorObjectType;
import com.ptcrys.fpsmatch.core.minimap.model.VectorsFile;
...
public final class MinimapModelCodecs {
    ...
    public static final Codec<MinimapLayer> LAYER = LAYER_TYPE.dispatch(
            "type",
            MinimapLayer::type,
            MinimapModelCodecs::codecForLayerType
    );
    ...
    public static final Codec<RegionGeometry> REGION_GEOMETRY = GEOMETRY_TYPE.dispatch(
            ...
            RegionGeometry::type,
            type -> switch (type) {
                case RECTANGLE -> RECTANGLE_GEOMETRY;
                case POLYGON -> POLYGON_GEOMETRY;
            }
    );
    ...
    public static final Codec<MinimapStyle> STYLE = STYLE_TYPE.dispatch(
            ...
            MinimapStyle::type,
            type -> switch (type) {
                case REGION -> REGION_STYLE;
                case LINE -> LINE_STYLE;
                case TEXT -> TEXT_STYLE;
                case ICON -> ICON_STYLE;
            }
    );
    ...
    public static final Codec<VectorObject> VECTOR_OBJECT = VECTOR_OBJECT_TYPE.dispatch(
            ...
            VectorObject::type,
            type -> switch (type) {
                case LINE -> VECTOR_LINE;
                case RECTANGLE -> VECTOR_RECTANGLE;
                case POLYGON -> VECTOR_POLYGON;
                case TEXT -> VECTOR_TEXT;
                case ICON -> VECTOR_ICON;
            }
    );
